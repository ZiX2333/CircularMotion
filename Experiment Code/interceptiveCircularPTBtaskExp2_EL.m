...
Sti.Speed = 200 * pi/180; % 200 degree/s = 0.2 degree/ms
...
for i = 1:num_trial
    ...
    FP.OffFrames(i) = round(randi(FP.OnDurRange) /1000 / ifi);
end
...
for i_trial = 1:num_trial
    ...
    if state_SacResp_flag == 1
        ...
        for i_frame = 1: Sti.SacFrames
            ...
            if sqrt(((FP.LocX-eyeX)/ppd).^2 + ((FP.LocY - eyeY)/ppd).^2)  > Sti.WindowSize / 2
                i_leaveF = i_leaveF+1;
