...
DataAdj(iTriali).WhichC = WhichC;
% store the previous saccade seq info
DataAdj(iTriali).PreSaccSeqInfo = Dataf(iTrial).SaccSeqInfo;
...
% store the post saccade seq info
DataAdj(iTriali).PostSaccSeqInfo = Dataf(iTrial).SaccSeqInfo;
