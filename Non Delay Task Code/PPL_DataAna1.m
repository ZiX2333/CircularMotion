...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Now this script is used for no delay task
% Adjusted on Mar 19, Plot Row eye traces, KL Divergence, Ending error as targ loc, Smooth pursuit
% Adjusted on Mar 27, adjust some plots
%% Txt information
...
%% 3 ZScore the RT and relation with saccade ending error
SecNum = SecNum+1;
if ismember(SecNum,SecPlots)
    iFigAcc = iFigAcc+1;
    figure(iFigAcc)
...
%% 5 plot the KL divergence across conditions
SecNum = SecNum+1;
if ismember(SecNum,SecPlots)
    iFigAcc = iFigAcc+1;
    figure(iFigAcc)
