% Data Processing
% This script is used for batch data processing
% Data is based on DataAll1 from AllSubj_Dates_PreProcessedN.mat, but is
% not for plotting averaging data across all subject, but is a batch
% processing for individual subject data.
% the difference between Batch processing and individual processing code is
% that the later one usually include some new analysis
