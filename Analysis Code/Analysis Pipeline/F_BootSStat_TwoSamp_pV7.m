...
function pVals = F_BootSStat_TwoSamp_pV7(ObsV1, ObsV2, ObsVAve1, ObsVAve2, ReTime)
...
for iReTime = 1:ReTime
    ...
    gobs = nanmean(poolAll(SampN(1:SampS),:));  % 1×numX
    gnull = nanmean(poolAll(SampN(SampS+1:end),:));
