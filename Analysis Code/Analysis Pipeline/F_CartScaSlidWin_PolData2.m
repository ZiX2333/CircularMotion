function [XAve, YAve, YStd] = F_CartScaSlidWin_PolData2(winSize,stepSize,XV,YV,winRange)
...
% Adjusted on Jul 11, 2025, a very big change!!! remove the sort at the end
%       All the code use this function after this date need to sort the data only when plot the result
%       All the code before this date when re run need to be careful
